...
export type VerifyQuery = { __typename?: 'Query', verifyToken: (
    { __typename?: 'user' }
    & { ' $fragmentRefs'?: { 'UserFragmentFragment': UserFragmentFragment } }
  ) };
